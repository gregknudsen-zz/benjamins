...
jQuery.fn.wowSlider = function(aj) {
        ...
        .animate(
          {
            left: aU
              ? -aU + "00%"
              : /Safari/.test(navigator.userAgent) ? "0%" : 0
          },
          k.duration,
          "easeInOutExpo",
          function() {
  ...
  if (
    ...
    T.css({ width: z + "00%", display: "table" });
  ...
  if (aj.gestures) {
    ...
    ay(
      ...
      function(k) {
        var f =
          /ws_playpause|ws_prev|ws_next|ws_bullets/g.test(k.target.className) ||
  ...
  aF(V).css({ zIndex: 56, right: "15px", bottom: "15px" }).appendTo(S);
      ...
      if (aT.length) {
        ...
        function aY(a7) {
          ...
          var a8 = {
            ...
            "margin-bottom":
              -a1.get(a7).offsetTop + a1.get(a1.length - 1).offsetTop + "px"
          };
          var a6 = aT.get(a7);
          var a5 = {
            left:
              -a6.offsetLeft +
                (aF(a6).outerWidth(true) - aF(a6).outerWidth()) / 2
          };
          if (c < 0) {
            aU.css(a8);
            f.css(a5);
      ...
      if (aU == c) {
        ...
        if (!at) {
          ...
          f
            ...
            .animate({
              left: -Math.max(
                Math.min(aT.left, -aV.left),
                aT.left + k.width() - al.width()
              ),
              top: -Math.max(
                Math.min(aT.top, 0),
                aT.top + k.height() - al.height()
              )
            });
        }
      } else {
  ...
  function aQ(c, aT) {
    ...
    (aa[aF.type(f)] || aa[f] || aa.none)(
      aF.extend({ $this: H, curIdx: x, prevIdx: au }, aj),
      D,
      aC,
      k,
      aU,
    ...
    if (w) {
      ...
      function ak() {
        ...
        if (an()) {
          ...
          aD = 1;
          H.wrap("<div class='ws_fs_wrapper'></div>").parent()[0][
            w.requestFullscreen
          ]();
        }
      }
...
(function(c) {
  ...
  for (; d < h.length && !g; d++) {
    ...
    f =
      f ||
      window[h[d] + "CancelAnimationFrame"] ||
      window[h[d] + "CancelRequestAnimationFrame"];
  }
  function e() {
    if (a) {
      g(e);
